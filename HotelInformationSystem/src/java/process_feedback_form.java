...
public class process_feedback_form extends HttpServlet {
    ...
    static final String USER = "feedbackUser";
    static final String PASS = "654123";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<title> Servlet process add feedback result </title>");
            out.println("</head>");
            out.println("<body>");
            /////////////////////////////////////////////////// header
            ...
            String sql = "INSERT INTO feedbacks (name,phone,email,"
                    + "subject,type,message,creationDateTime) VALUES (?,?,?,?,?,?,"
